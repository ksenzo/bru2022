...
let productBeerBody = document.querySelector('.hello__body');
let line5 = document.querySelector('.fives-row__text');
...
window.onscroll = function showHeaderCollection() {
   ...
   let position4 = `${pos}px`;
   if (window.pageYOffset > 0) {
      fixedHeaderCollection.classList.add('__fixed');
      line5.style.transform = 'translateX(-' + position4 + ')';
